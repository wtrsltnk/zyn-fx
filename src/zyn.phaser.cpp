    ...
    : AudioEffectX(audioMaster, 1, 1) // 1 program, 1 parameter only
{
    ...
    _effectMgr->changeeffect(EffectTypes::PhaserType);
}
...
{
    strcpy_s(name, kVstMaxEffectNameLen, "Zyn.Phaser");
    return true;
}
...
{
    strcpy_s(text, kVstMaxProductStrLen, "Zyn.Phaser");
    return true;
}
