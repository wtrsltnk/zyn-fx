    ...
    : AudioEffectX(audioMaster, 1, 1) // 1 program, 1 parameter only
{
    ...
    _effectMgr->changeeffect(EffectTypes::DistorsionType);
}
...
{
    strcpy_s(name, kVstMaxEffectNameLen, "Zyn.Distorsion");
    return true;
}
...
{
    strcpy_s(text, kVstMaxProductStrLen, "Zyn.Distorsion");
    return true;
}
