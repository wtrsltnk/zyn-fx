    ...
    : AudioEffectX(audioMaster, 1, 1) // 1 program, 1 parameter only
{
    ...
    _effectMgr->changeeffect(EffectTypes::EchoType);
}
...
{
    strcpy_s(name, kVstMaxEffectNameLen, "Zyn.Echo");
    return true;
}
...
{
    strcpy_s(text, kVstMaxProductStrLen, "Zyn.Echo");
    return true;
}
