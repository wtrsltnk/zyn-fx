    ...
    : AudioEffectX(audioMaster, 1, 1) // 1 program, 1 parameter only
{
    ...
    _effectMgr->changeeffect(EffectTypes::DynamicFilterType);
}
...
{
    strcpy_s(name, kVstMaxEffectNameLen, "Zyn.DynamicFilter");
    return true;
}
...
{
    strcpy_s(text, kVstMaxProductStrLen, "Zyn.DynamicFilter");
    return true;
}
