...
public:
    ...
    float *const efxoutl = nullptr; /**<Effect out Left Channel*/
    float *const efxoutr = nullptr; /**<Effect out Right Channel*/
    ...
    FilterParams *filterpars = nullptr; /**<Parameters for filters used by Effect*/
